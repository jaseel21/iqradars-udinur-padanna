          ...
          <div className="flex justify-between items-center h-16">
            ...
            >
              <div className="relative">
                <div >
                  <img src="icon.png" className="w-20 h-20 p-2"></img>
                </div>
              </div>
              <div className="flex flex-col">
                <span className="text-xl font-semibold bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent leading-tight">
                  Iqra Dars Udinur & Padne
                </span>
                <span className="text-xs text-gray-500 font-medium tracking-wide">Islamic Education Institution</span>
              </div>
            </motion.a>
